...
import SkeletonFallback from "../fallback/Skeleton/SkeletonFallback";
    ...
    const callProducts = async () => {
      try {
        const res = await axios.get(
          "https://shopping-server-kx93.onrender.com/api/products"
        );
        ...
        <Grid item xs={2.4}>
          <Card variant="outlined">
            <CardActionArea>
              ...
              <CardContent>
                <Typography className={classes.limitTitle} gutterBottom>
                  Áo khoác cadigan nam nữ chất cotton tổ ong cao cấp, dễ mặc dễ
                  phối đồ, hợp mọi thời đại
                </Typography>
                <Stack direction="row" justifyContent="space-between">
                  <Typography color="error">200.000đ</Typography>
                  <Typography> Đã bán 10</Typography>
          ...
          products.map((product, index) => {
            ...
            return (
              <Grid item xs={2.4} key={index}>
                ...
                >
                  <CardActionArea>
                    <CardMedia component="img" src={product.productImages[0]} />
                    <CardContent>
                      <Typography className={classes.limitTitle} gutterBottom>
                        {product ? product.name : <Skeleton animation="wave" />}
                      </Typography>
                      <Stack direction="row" justifyContent="space-between">
                        <Typography color="error">{product.price}đ</Typography>
