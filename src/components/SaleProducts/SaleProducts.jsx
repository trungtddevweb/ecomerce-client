...
const SaleProducts = () => {
    ...
    return (
        <Box className={classes.marginAuto} sx={{ py: 5 }}>
            <Stack
                direction="row"
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                <Typography
                                    ...
                                    gutterBottom
                                >
                                    Áo khoác nam unisex cổ trụ vải dù nhật 2 lớp
                                    phong cách trường học hàn quốc họa tiết chữ
                                    At7
                                </Typography>
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                <Typography
                                    ...
                                    gutterBottom
                                >
                                    Áo phông tay lỡ form rộng nam nữ unisex chữ
                                    WHEN EVER vải dày mịn
                                </Typography>
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                <Typography
                                    ...
                                    gutterBottom
                                >
                                    Áo Polo Nam Cổ Bẻ Thun Basic Cộc Tay Chất
                                    Cotton Co Dãn Thoáng Mát Phong Cách Trẻ
                                    Trung Thời Trang Zenkonu TOP NAM 230
                                </Typography>
                                <Rating size="small" value={5} readOnly />
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                <Typography
                                    ...
                                    gutterBottom
                                >
                                    Áo thun Tia Sét, chất Cotton Co Giãn 4 Chiều
                                    -Hàng Hot Trend 2023
                                </Typography>
                                <Rating size="small" value={5} readOnly />
